...
const columnsConfig = [
  ...
  {
    accessorKey: "nonResponseProgramsNames",
    header: "Programs",
    type: ["array", "vertical"],
  },
];

export default async function NonRespondersPage() {
  try {
    ...
    return (
      <>
        <Header
          ...
          subTitle="Participants without code letters for registered programs"
        />
        <DynamicDataTable
    ...
    console.error("Error loading non-responders page:", error.message);
    return (
      <ErrorPage
        statusCode={500}
